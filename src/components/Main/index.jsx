    ...
    <div>
      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <div>
            <h1 className="text-5xl font-bold">Welcome to CyberGuardian !</h1>
            <p className="py-6">
              Your digital shield in the cyber frontier! <br />
              We're here to make your online experience safe and secure. Explore
              confidently with our expert guidance and cutting-edge solutions.
              Your safety, our priority. Join us in shaping a cyber-secure
              future!
            </p>
      ...
      <div className="bg-base-300 p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded shadow-md">
            ...
            <h3 className="text-l font-bold mb-2">Password Stregnth Checker</h3>
            <img
              src={passwordPic}
            ...
            <Link to="/PasswordMeter">
              <button className="btn btn-primary text-l">Click Me</button>
            </Link>
          </div>
          <div className="bg-white p-4 rounded shadow-md">
            {/* Tool content goes here */}
            <h3 className="text-l font-bold mb-2">Email Header Analyzer</h3>
            <img
              src={EmailPic}
          ...
          <div className="bg-white p-4 rounded shadow-md">
            {/* Tool content goes here */}
            <h3 className="text-l font-bold mb-2">Image Steganography Tool</h3>
            <img
              src={steImg}
              alt="stegano"
              className=" rounded-lg shadow-1xl"
