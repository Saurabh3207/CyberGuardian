...
function Chatbot() {
	...
	return (
		<div>
			<Header />
			<div className="flex p-8 min-h-fit justify-center">
				<div className="styles.hero-image p-8 flex-1">
					<img src={svgImage} alt="intro" className="w-96 h-80" />
				</div>
				<div className="flex w-full justify-center flex-1 ">
					<div styles={styles.Chatbot} className="justify-end flex flex-col">
