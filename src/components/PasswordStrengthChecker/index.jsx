...
const PasswordStrengthChecker = () => {
  ...
  return (
    <div className={`${styles["password-strength-checker"]} ${styles.valid}`}>
      ...
      <div className={styles["requirements"]}>
        <p
          className={`${styles["requirement"]} ${
            requirementsMet.hasUppercase ? styles["fulfilled"] : ""
          }`}
        >
        ...
        <p
          className={`${styles["requirement"]} ${
            requirementsMet.isAlphanumeric ? styles["fulfilled"] : ""
          }`}
        >
        ...
        <p
          className={`${styles["requirement"]} ${
            requirementsMet.startsWithUppercase ? styles["fulfilled"] : ""
          }`}
        >
        ...
        <p
          className={`${styles["requirement"]} ${
            requirementsMet.hasNumeric ? styles["fulfilled"] : ""
          }`}
        >
        ...
        <p
          className={`${styles["requirement"]} ${
            requirementsMet.isLengthValid ? styles["fulfilled"] : ""
          }`}
        >
      ...
      {strength && (
        <div
          className={`${styles["strength-indicator"]} ${
            styles[strength.toLowerCase()]
          }`}
        >
          {strength}
        </div>
